#ifndef TACHACOINDGP_H
#define TACHACOINDGP_H
...
public:
    ...
    TachacoinDGP(TachacoinState* _state, bool _dgpevm = true) : dgpevm(_dgpevm), state(_state) { initDataSchedule(); }
