    ...
    m_results(1)
{
    ...
    ui->labelAmount->setToolTip(tr("The amount in TACHACOIN to send. Default = 0."));
    ui->labelSenderAddress->setToolTip(tr("The tachacoin address that will be used as sender."));
