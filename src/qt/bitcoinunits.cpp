...
QString BitcoinUnits::longName(int unit)
{
    switch(unit)
    {
    case BTC: return QString("TACHACOIN");
    case mBTC: return QString("mTACHACOIN");
    case uBTC: return QString::fromUtf8("μTACHACOIN (bits)");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString("Tachacoins");
    case mBTC: return QString("Milli-Tachacoins (1 / 1" THIN_SP_UTF8 "000)");
    case uBTC: return QString("Micro-Tachacoins (bits) (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
