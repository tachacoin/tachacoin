#ifndef TACHACOIN_QT_TOKENTOKENTRANSACTIONTABLEMODEL_H
#define TACHACOIN_QT_TOKENTOKENTRANSACTIONTABLEMODEL_H
...
#endif // TACHACOIN_QT_TOKENTOKENTRANSACTIONTABLEMODEL_H
