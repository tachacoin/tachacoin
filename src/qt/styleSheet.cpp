...
class TachacoinStyle : public QProxyStyle
{
public:
...
void StyleSheet::setStyleSheet(QApplication *app, const QString& style_name)
{
    ...
    TachacoinStyle* tachacoinStyle = new TachacoinStyle;
    tachacoinStyle->setBaseStyle(mainStyle);
    app->setStyle(tachacoinStyle);
