#ifndef TACHACOINVERSIONCHECKER_H
#define TACHACOINVERSIONCHECKER_H

#include <QObject>

#define TACHACOIN_RELEASES "https://github.com/tachacoin/tachacoin/releases"
...
class TachacoinVersionChecker : public QObject
{
    Q_OBJECT
public:
    explicit TachacoinVersionChecker(QObject *parent = 0);
    ~TachacoinVersionChecker();
...
#endif // TACHACOINVERSIONCHECKER_H
