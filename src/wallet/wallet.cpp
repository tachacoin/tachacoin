...
void CWallet::StakeTachacoins(bool fStake, CConnman* connman)
{
    ::StakeTachacoins(fStake, this, connman, stakeThread);
}

void CWallet::StartStake(CConnman *connman)
{
    StakeTachacoins(true, connman);
}
