...
from test_framework.tachacoin import activate_mpos
...
class TachacoinCallContractTimestampTest(BitcoinTestFramework):
...
if __name__ == '__main__':
    TachacoinCallContractTimestampTest().main()
